-- ============================================
-- AyurSutram Database Schema v1.0 - Complete
...
CREATE TABLE appointments (
    ...
    -- Relaxed constraint: allows cancelled/scheduled without all details
...
-- ============================================
-- PRESCRIPTION MANAGEMENT (AI-Powered)
-- ============================================
...
CREATE TABLE prescriptions (
    ...
    -- Medicines (simple JSONB array) - GENERATED BY AI
    ...
    */
    ...
    ai_suggestions JSONB, -- What AI originally suggested (for audit)
...
-- ============================================
-- HELPER FUNCTIONS FOR AI PRESCRIPTION
-- ============================================
...
-- Get patient data formatted for AI prescription generation
CREATE OR REPLACE FUNCTION get_patient_data_for_ai(patient_id UUID)
RETURNS JSONB AS $$
DECLARE
    patient_data JSONB;
BEGIN
