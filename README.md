...
- **AI-Powered Search**: Find the right healthcare professionals based on symptoms
...
- **AI/ML**: Groq SDK for symptom analysis
...
#### API Routes
- `/api/ai-search-enhanced` - AI-powered caregiver search
...
const symptomToSpecialization = {
  'pregnancy': ['Pregnancy Care', 'ANC Care', 'Postnatal Care'],
  'elderly': ['Elder Care'],
